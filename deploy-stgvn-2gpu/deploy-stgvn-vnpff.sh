...
-v "${rootvolume}/data/STG2/STG2-SOC/license.dat/:/server/modules/module_so/soc/core/authorization/license.dat" \
-v "${rootvolume}/data/STG2/STG2-API/license.dat/:/server/api/authorization/license.dat" \
-v "${rootvolume}/data/private_key.pem:/server/api/two_way_authentication/private_key.pem" \
-v "${rootvolume}/vn_table_reconstruction/:/server/modules/module_so/soc/core/table_reconstruction/vn_table_reconstruction" \
